...
const UploadTab = ({ configData }) => {
    ...
    const [selectedLanguage, setSelectedLanguage] = useState(''); // For selected language
        ...
        <div className="upload-pane">
            ...
            <div className="form-group">
                ...
                <select
                    ...
                    value={selectedCategory} // Bind to the state (array)
                    onChange={(e) => {
                        const selectedOptions = Array.from(e.target.selectedOptions, (option) => option.value);
                        setSelectedCategory(selectedOptions); // Update state with selected options
                    }}
                >
