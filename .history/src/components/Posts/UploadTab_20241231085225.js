...
const UploadTab = ({ configData }) => {
    ...
    const isFormComplete =  scheduledTime && selectedParty && selectedState  && imageFile && selectedCategory;
    ...
    const handleUpload = async () => {
        if (!isFormComplete){
            alert('Please select both party, state, category and image to upload.');
            return;
        }
